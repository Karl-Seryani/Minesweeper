...
namespace {
struct qt_meta_tag_ZN11MinesweeperE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11MinesweeperE = QtMocHelpers::stringData(
    "Minesweeper",
    "handleCellClick",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11MinesweeperE[] = {
...
Q_CONSTINIT const QMetaObject Minesweeper::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11MinesweeperE.offsetsAndSizes,
    qt_meta_data_ZN11MinesweeperE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11MinesweeperE_t,
        // Q_OBJECT / Q_GADGET
...
void *Minesweeper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11MinesweeperE.stringdata0))
